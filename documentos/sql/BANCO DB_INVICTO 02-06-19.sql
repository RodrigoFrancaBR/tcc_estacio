...
CREATE TABLE IF NOT EXISTS `DB_INVICTO`.`TB_UNIDADE` (
  ...
  `ativo` VARCHAR(7) NOT NULL COMMENT 'USADO PARA EXCLUSÃO LÓGICA \nAtivado ',
...
CREATE TABLE IF NOT EXISTS `DB_INVICTO`.`TB_TURMA` (
  ...
  `nome` VARCHAR(45) NOT NULL,
  `ativo` VARCHAR(7) NOT NULL COMMENT 'USADO PARA EXCLUSÃO LÓGICA Ativo/Inativo',
...
CREATE TABLE IF NOT EXISTS `DB_INVICTO`.`TB_CONTRATO` (
  ...
  `situacao_matricula` VARCHAR(45) NOT NULL COMMENT 'PROCESSO DE MATRÍCULA, ATIVO/MATRICULADO, CANCELADO, ACORDO, ENCERRADO',
